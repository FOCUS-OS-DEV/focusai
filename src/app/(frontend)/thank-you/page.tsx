      ...
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-purple-100 shadow-[0_20px_50px_rgba(168,85,247,0.15)] text-center">
          ...
          <div className="space-y-4 mb-8">
            ...
            <p className="text-[#a855f7] font-bold text-lg">
              נציג מהצוות יחזור אליכם תוך 24 שעות
            </p>
          </div>

          {/* What's Next */}
          <div className="bg-purple-50/50 rounded-2xl p-6 border border-purple-100 mb-8">
            <h3 className="text-lg font-bold text-gray-900 mb-4">בינתיים...</h3>
            <div className="space-y-3 text-right">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-[#a855f7]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  <span>1</span>
                </div>
                <span className="text-gray-600">שלחנו לכם מייל אישור - בדקו את תיבת הדואר</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-[#a855f7]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  <span>2</span>
                </div>
                <span className="text-gray-600">עקבו אחרינו ברשתות לעדכונים שוטפים</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-[#a855f7]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                  <span>3</span>
                </div>
                <span className="text-gray-600">הצטרפו לקהילת הווטסאפ שלנו</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/"
              className="px-8 py-3 text-base font-bold rounded-full bg-gradient-to-r from-[#a855f7] to-[#ec4899] text-white shadow-[0_10px_25px_rgba(168,85,247,0.4)] hover:shadow-[0_20px_40px_rgba(168,85,247,0.5)] transition-all duration-300"
            >
              חזרה לדף הבית
            </Link>
            <Link
              href="/ai-ready"
              className="px-8 py-3 text-base font-bold rounded-full border-2 border-[#a855f7] text-[#a855f7] hover:bg-[#a855f7]/10 transition-all duration-300"
            >
              עוד על ההכשרה
            </Link>
          </div>

  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-10 md:mb-12 px-4">
        <p className="text-purple-500 text-sm uppercase tracking-[0.3em] mb-3 font-medium">
          Trusted By
        </p>
      ...
      >
        <div
          className="flex w-fit hover:[animation-play-state:paused] animate-scroll-right"
          style={{

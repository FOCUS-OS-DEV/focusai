              ...
              {isSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    className="px-6 py-3 rounded-xl text-white font-bold disabled:opacity-50 transition-all whitespace-nowrap hover:scale-105"
                    style={{
            ...
            >
              ...
              <div className="bg-[#0f0a1e] rounded-3xl p-8 md:p-10">
                ...
                <div className="space-y-4">
                  ...
                  {/* Animated cursor */}
                  <div className="inline-block w-2 h-5 bg-blue-400 animate-pulse" />
                </div>
              </div>
            </div>
          </div>

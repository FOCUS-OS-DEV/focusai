    ...
    >
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        <div className="text-center">
          ...
          {/* Main Title */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 animate-fade-in-up animate-delay-100">
            <span className="gradient-text">Focus AI</span>
            <span className="text-gray-900"> Academy</span>
          </h1>

          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto mb-4 leading-relaxed animate-fade-in-up animate-delay-200">
            מרכז ההכשרות המוביל בישראל לעולם ה-AI
          </p>

          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-10 animate-fade-in-up animate-delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in-up animate-delay-300">
            <a
              href="#programs"
              className="group relative px-8 py-4 rounded-full text-white font-bold text-lg overflow-hidden transition-all hover:scale-105"
              style={{
            ...
            <a
              href="#contact"
              className="px-8 py-4 rounded-full font-bold text-lg text-purple-600 border-2 border-purple-300 hover:bg-purple-50 hover:border-purple-400 transition-all duration-300 hover:scale-105"
            >
              שיחת ייעוץ חינם
            </a>
          </div>
          ...
          {/* Trust indicators */}
          <div className="pt-8 border-t border-purple-200 animate-fade-in-up animate-delay-500">

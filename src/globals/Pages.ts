    ...
    // ============ AI READY LANDING PAGE ============
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'סילבוס',
          admin: {
            description: 'תכנית הלימודים - 8 מפגשים',
          },
          fields: [
            {
              name: 'badge',
              type: 'text',
              label: 'תג',
              defaultValue: '📚 תכנית לימודים',
            },
            {
              name: 'title',
              type: 'text',
              label: 'כותרת',
              defaultValue: 'סילבוס במיתקד יישומי ופרקטי',
            },
            {
              name: 'subtitle',
              type: 'textarea',
              label: 'תת-כותרת',
              defaultValue: '8 מפגשים שיעניקו לך את הכלים לשגשוג בעידן ה-AI - פרונטלי או בזום, בימים וערבים',
            },
            {
              name: 'meetings',
              type: 'array',
              ...
              admin: {
                initCollapsed: true,
                description: 'הוסף מפגשים עם כותרות, תיאורים וכלים',
              },
              fields: [
                {
                  name: 'number',
                ...
                },
                {
                  ...
                  label: 'נושאים',
                  admin: {
                    description: 'נקודות מפתח או נושאים',
                  },
                  fields: [
                    {
                      name: 'text',
                ...
                },
                {
                  ...
                  admin: {
                    description: 'תגיות לכלים (ChatGPT, Claude, וכו\')',
                  },
                  fields: [
                    {
                      name: 'name',
                ...
                },
                {
                  ...
                  label: 'אייקון',
                  admin: {
                    description: 'אמוג\'י או אייקון למפגש',
                  },
                },
              ],
            },
        ...
        },
        {
          ...
          label: 'למה עכשיו',
          admin: {
            description: 'סקשן "למה עכשיו זה הזמן"',
          },
          fields: [
            {
              name: 'badge',
              type: 'text',
              label: 'תג',
              defaultValue: '⏰ למה עכשיו?',
            },
            {
              name: 'title',
              type: 'text',
              label: 'כותרת',
              defaultValue: 'למה עכשיו זה הזמן?',
            },
            {
              name: 'cards',
              type: 'array',
